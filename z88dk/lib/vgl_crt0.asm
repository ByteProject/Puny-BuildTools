;       Startup Code for V-Tech "Genius Leader" [DE], aka. "PreComputer" [US]
;       Especially for the older models 1000, 2000, 4000, 4004 Quatro XL
;
;	HotKey 2017-09-14
;
;       $Id: vgl_crt0.asm,v 1.00 2017-09-14 16:30:00 hotkey Exp $
;
