...
aciaRxIn:       defw aciaRxBuffer       ; non-zero item in data since it's initialized anyway
aciaRxOut:      defw aciaRxBuffer       ; non-zero item in data since it's initialized anyway
