...
siobTxIn:       defw siobTxBuffer       ; non-zero item in data since it's initialized anyway
siobTxOut:      defw siobTxBuffer       ; non-zero item in data since it's initialized anyway
