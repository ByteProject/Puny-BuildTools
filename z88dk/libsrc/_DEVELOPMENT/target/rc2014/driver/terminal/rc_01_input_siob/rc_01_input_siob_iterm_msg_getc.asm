...
PUBLIC rc_01_input_siob_iterm_msg_getc

EXTERN _siob_pollc, _siob_getc

rc_01_input_siob_iterm_msg_getc:
...
block_loop:
   ...
   call _siob_pollc            ; check whether any characters are in Rx buffer
