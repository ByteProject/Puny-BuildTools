...
PUBLIC rc_01_input_sioa_iterm_msg_getc

EXTERN _sioa_pollc, _sioa_getc

rc_01_input_sioa_iterm_msg_getc:
...
block_loop:
   ...
   call _sioa_pollc            ; check whether any characters are in Rx buffer
