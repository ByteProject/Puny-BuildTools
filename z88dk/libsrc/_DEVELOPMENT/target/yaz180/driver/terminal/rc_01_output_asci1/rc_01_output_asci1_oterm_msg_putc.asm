...
EXTERN l_jpix, asm_asci1_putc

rc_01_output_asci1_oterm_msg_putc:
...
cooked:
rc_01_output_asci1_oterm_msg_putc_raw:

   ; c = ascii code

   bit 4,(ix+6)
   jr z, rc_01_output_asci1_oterm_msg_putc_send   ; if not processing crlf
   ...
   cp CHAR_LF
   jr nz, rc_01_output_asci1_oterm_msg_putc_send

   ; send cr+lf
   
   ld c,13
   call rc_01_output_asci1_oterm_msg_putc_send
   
   ld c,10

rc_01_output_asci1_oterm_msg_putc_send:
