...
cooked:
rc_01_output_asci0_oterm_msg_putc_raw:

   ; c = ascii code

   bit 4,(ix+6)
   jr z, rc_01_output_asci0_oterm_msg_putc_send   ; if not processing crlf
   ...
   cp CHAR_LF
   jr nz, rc_01_output_asci0_oterm_msg_putc_send
...
rc_01_output_asci0_oterm_msg_putc_send:
