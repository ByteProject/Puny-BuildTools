...
void putpic(int x, int y, int picture) {			
	//putsprite(spr_or,(x*spritesize),(y*spritesize),sprites + (spritemem * (*ptr++)));			
	if (picture == 0) {
		display[y*128+272+x*2]=192;
		display[y*128+272+x*2+1]=192;
		display[y*128+272+64+x*2]=192;
		display[y*128+272+64+x*2+1]=192;
	} else {
		display[y*128+272+x*2]=193+4*picture-4;				
		display[y*128+272+x*2+1]=193+4*picture-2;				
		display[y*128+272+64+x*2]=193+4*picture-3;				
		display[y*128+272+64+x*2+1]=193+4*picture-1;
	}
}
