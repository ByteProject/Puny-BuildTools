...
extern void z180_delay_tstate(uint16_t tstates);


extern uint8_t z180_get_int_state(void);


extern void z180_set_int_state(uint8_t state);
...
extern void *z180_inir(void *dst,uint8_t port,uint8_t num);


extern void *z180_indr(void *dst,uint8_t port,uint8_t num);


extern void z180_outp(uint16_t port,uint8_t data);


extern void *z180_otir(void *src,uint8_t port,uint8_t num);


extern void *z180_otdr(void *src,uint8_t port,uint8_t num);
