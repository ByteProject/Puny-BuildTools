...
extern void ulap_enable(void);


extern void ulap_disable(void);



// Read or Write Many Palette Entries

extern void *ulap_read_palette(void *dst,unsigned char pent,unsigned char num);


extern void *ulap_write_palette(void *src,unsigned char pent,unsigned char num);



// Read or Write a Single Palette Entry

extern unsigned char ulap_read_color(unsigned char pent);


extern void ulap_write_color(unsigned char pent,unsigned char color);



// Runtime Versions of Selected Macros

extern unsigned char ulap_attr_from_pentp_penti(unsigned char pentp,unsigned char penti);


extern unsigned char ulap_pent_from_attr_ink(unsigned char attr);


extern unsigned char ulap_pent_from_attr_paper(unsigned char attr);
