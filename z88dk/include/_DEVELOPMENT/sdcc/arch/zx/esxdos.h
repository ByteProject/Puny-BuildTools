...
extern unsigned char errno_from_esxdos(unsigned char esxdos_error) __preserves_regs(b,c,d,e,iyl,iyh);
extern unsigned char errno_from_esxdos_fastcall(unsigned char esxdos_error) __preserves_regs(b,c,d,e,iyl,iyh) __z88dk_fastcall;
#define errno_from_esxdos(a) errno_from_esxdos_fastcall(a)
