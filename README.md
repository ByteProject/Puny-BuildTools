...
What a ride! Wouldn't it be nice and convenient if you could adivse the Puny BuildTools to create a .ZIP file with all relevant contents of project, ready for distribution? That's exactly what the `bundle.sh` utility in your project directory is for. The synopsis is: 
