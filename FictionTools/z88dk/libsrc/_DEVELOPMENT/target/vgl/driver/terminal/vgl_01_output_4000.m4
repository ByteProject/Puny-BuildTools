dnl############################################################
dnl##      VGL_01_OUTPUT_4000 STATIC INSTANTIATOR            ##
dnl############################################################
dnl##                                                        ##
dnl## m4_vgl_01_output_4000(...)                             ##
dnl##                                                        ##
...
define(`m4_vgl_01_output_4000',dnl

   ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ; FILE  : `ifelse($1,0,`(none)',$1)'
   ;
   ; driver: vgl_01_output_4000
   ; fd    : __I_FCNTL_NUM_FD
   ; mode  : write only
   ...
   __i_fcntl_fdstruct_`'__I_FCNTL_NUM_FD:
      ...
      ; More options can be added on demand
