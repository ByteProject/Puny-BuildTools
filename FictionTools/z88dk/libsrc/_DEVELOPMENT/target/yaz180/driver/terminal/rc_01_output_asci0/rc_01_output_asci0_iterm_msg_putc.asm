...
EXTERN rc_01_output_asci0_oterm_msg_putc_raw

rc_01_output_asci0_iterm_msg_putc:
   ...
   ld a,c
   cp 32
   jp nc, rc_01_output_asci0_oterm_msg_putc_raw

   cp CHAR_LF
   jp z, rc_01_output_asci0_oterm_msg_putc_raw

   ld c,'?'
   jp rc_01_output_asci0_oterm_msg_putc_raw
