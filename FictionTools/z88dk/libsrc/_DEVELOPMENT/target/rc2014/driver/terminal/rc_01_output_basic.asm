...
PUBLIC rc_01_output_basic

EXTERN console_01_output_terminal, error_zc
EXTERN rc_01_output_basic_oterm_msg_putc, rc_01_output_basic_stdio_msg_ictl
EXTERN rc_01_output_basic_iterm_msg_putc, rc_01_output_basic_iterm_msg_bs
EXTERN rc_01_output_basic_oterm_msg_bell, rc_01_output_basic_iterm_msg_bell
...
rc_01_output_basic:
   ...
   cp OTERM_MSG_BELL
   jp z, rc_01_output_basic_oterm_msg_bell
   
   cp ITERM_MSG_BELL
   jp z, rc_01_output_basic_iterm_msg_bell
