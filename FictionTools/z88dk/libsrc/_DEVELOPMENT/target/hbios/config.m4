...
include(`target/hbios/config/config_target.m4')
include(`target/hbios/config/config_cpu.m4')
include(`target/hbios/config/config_clib.m4')
include(`target/hbios/config/config_clib_const.m4')
