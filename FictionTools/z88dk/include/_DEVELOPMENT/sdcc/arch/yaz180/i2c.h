...
extern uint8_t i2c_available(uint8_t device) __preserves_regs(b,c,d,e,iyh,iyl);
extern uint8_t i2c_available_fastcall(uint8_t device) __preserves_regs(b,c,d,e,iyh,iyl) __z88dk_fastcall;
#define i2c_available(a) i2c_available_fastcall(a)



// void i2c_set_speed( uint8_t device, enum i2c_speed_mode ) __z88dk_callee;
extern void i2c_set_speed(uint8_t device,i2c_speed_mode speed) __preserves_regs(d,e,iyh,iyl);
extern void i2c_set_speed_callee(uint8_t device,i2c_speed_mode speed) __preserves_regs(d,e,iyh,iyl) __z88dk_callee;
...
extern void i2c_write(uint8_t device,uint8_t addr,uint8_t *dp,uint8_t length,uint8_t mode) __preserves_regs(iyh,iyl);
extern void i2c_write_callee(uint8_t device,uint8_t addr,uint8_t *dp,uint8_t length,uint8_t mode) __preserves_regs(iyh,iyl) __z88dk_callee;
...
extern void i2c_read_set(uint8_t device,uint8_t addr,uint8_t *dp,uint8_t length,uint8_t mode) __preserves_regs(iyh,iyl);
extern void i2c_read_set_callee(uint8_t device,uint8_t addr,uint8_t *dp,uint8_t length,uint8_t mode) __preserves_regs(iyh,iyl) __z88dk_callee;
...
extern uint8_t i2c_read_chk(uint8_t device,uint8_t addr,uint8_t length) __preserves_regs(iyh,iyl);
extern uint8_t i2c_read_chk_callee(uint8_t device,uint8_t addr,uint8_t length) __preserves_regs(iyh,iyl) __z88dk_callee;
...
extern uint8_t i2c_read_get(uint8_t device,uint8_t addr,uint8_t length) __preserves_regs(iyh,iyl);
extern uint8_t i2c_read_get_callee(uint8_t device,uint8_t addr,uint8_t length) __preserves_regs(iyh,iyl) __z88dk_callee;
