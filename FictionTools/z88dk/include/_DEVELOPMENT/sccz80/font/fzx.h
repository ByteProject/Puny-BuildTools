...
extern void __LIB__ fzx_state_init_callee(struct fzx_state *fs,struct fzx_font *ff,struct r_Rect16 *window) __smallc __z88dk_callee;
...
extern void __LIB__ fzx_at_callee(struct fzx_state *fs,uint16_t x,uint16_t y) __smallc __z88dk_callee;
#define fzx_at(a,b,c) fzx_at_callee(a,b,c)


extern int __LIB__ fzx_putc(struct fzx_state *fs,int c) __smallc;
extern int __LIB__ fzx_putc_callee(struct fzx_state *fs,int c) __smallc __z88dk_callee;
...
extern char __LIB__ *fzx_char_metrics_callee(struct fzx_font *ff,struct fzx_cmetric *fm,int c) __smallc __z88dk_callee;
...
extern uint16_t __LIB__ fzx_glyph_width_callee(struct fzx_font *ff,int c) __smallc __z88dk_callee;
...
extern uint16_t __LIB__ fzx_string_extent_callee(struct fzx_font *ff,char *s) __smallc __z88dk_callee;
...
extern char __LIB__ *fzx_string_partition_callee(struct fzx_font *ff,char *s,uint16_t allowed_width) __smallc __z88dk_callee;
...
extern char __LIB__ *fzx_string_partition_ww_callee(struct fzx_font *ff,char *s,uint16_t allowed_width) __smallc __z88dk_callee;
...
extern uint16_t __LIB__ fzx_buffer_extent_callee(struct fzx_font *ff,char *buf,uint16_t buflen) __smallc __z88dk_callee;
...
extern char __LIB__ *fzx_buffer_partition_callee(struct fzx_font *ff,char *buf,uint16_t buflen,uint16_t allowed_width) __smallc __z88dk_callee;
...
extern char __LIB__ *fzx_buffer_partition_ww_callee(struct fzx_font *ff,char *buf,uint16_t buflen,uint16_t allowed_width) __smallc __z88dk_callee;
...
extern int __LIB__ fzx_puts_callee(struct fzx_state *fs,char *s) __smallc __z88dk_callee;
...
extern int __LIB__ fzx_puts_justified_callee(struct fzx_state *fs,char *s,uint16_t allowed_width) __smallc __z88dk_callee;
...
extern int __LIB__ fzx_write_callee(struct fzx_state *fs,char *buf,uint16_t buflen) __smallc __z88dk_callee;
...
extern int __LIB__ fzx_write_justified_callee(struct fzx_state *fs,char *buf,uint16_t buflen,uint16_t allowed_width) __smallc __z88dk_callee;
...
extern int __LIB__ fzx_tshr_putc(struct fzx_tshr_state *fs,int c) __smallc;
extern int __LIB__ fzx_tshr_putc_callee(struct fzx_tshr_state *fs,int c) __smallc __z88dk_callee;
